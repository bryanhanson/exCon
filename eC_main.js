...
// All cause things to be appended to global variable 'svg' defined in eC_globals.js
// Many modify or use the key global variables xD & yD

drawOutlines(); // Appends rectangles outlining the areas we'll be using.
drawControls();
drawMap(); // Appends an svg:path object (the contour lines) and draws them in the map region.
...
svg.on('mousemove', activateGuides); // controls mouse behavior and drawing of slices
